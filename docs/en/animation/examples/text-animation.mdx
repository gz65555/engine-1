...
This example demonstrates how to create text animations in the Oasishub editor. Through simple steps, you will learn how to create an animation clip for text. If this is your first time using the animation editor, it is recommended to read the previous documents:
