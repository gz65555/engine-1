...
| Oasishub Version | Spine Version | @oasishub/engine-spine Version |
|------------------|---------------|-------------------------------|
| ≤ 1.2            | Spine 3.8     | 1.2.0                         |
...
### Questions  
For any questions about Spine, feel free to create an issue in the `@oasishub/engine-spine` repository.
