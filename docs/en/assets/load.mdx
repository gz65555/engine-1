...
In Oasishub, asset loading is generally divided into three situations based on its usage:
...
```typescript
engine.resourceManager.baseUrl = "";
```
...
The actual loading path from the above two lines of code will be `
