...
[Script components](/en/docs/script) are an important extension capability provided by the engine for developers. In the Oasishub editor, scripts are also a type of asset.
