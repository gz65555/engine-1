...
Collider components are used to define the physical properties and collision behavior of objects. The Oasishub physics system provides three types of colliders:
