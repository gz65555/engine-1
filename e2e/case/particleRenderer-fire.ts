...
WebGLEngine.create({
  ...
  scene.background.solidColor = new Color(0.05087608817155679, 0.05087608817155679, 0.05087608817155679, 1);
...
function createFireGlowParticle(fireEntity: Entity, texture: Texture2D): void {
  ...
  main.startColor.constant = new Color(1.0, 0.12743768043564743, 0, 168 / 255);
...
function createFireSmokeParticle(fireEntity: Entity, texture: Texture2D): void {
  ...
  main.startColor.constant = new Color(1.0, 1.0, 1.0, 84 / 255);
  ...
  const colorKeys = gradient.colorKeys;
  colorKeys[0].time = 0;
  colorKeys[0].color.set(1.0, 0.12213877222960187, 0.0, 1.0);
  colorKeys[1].time = 0.679;
  colorKeys[1].color.set(0, 0, 0, 1.0);
  gradient.addColorKey(0.515, new Color(1.0, 0.12213877222960187, 0.0, 1.0));
...
function createFireEmbersParticle(fireEntity: Entity, texture: Texture2D): void {
  ...
  gradientMax.addColorKey(0.71, new Color(1.0, 0.5972017883637634, 0, 1.0));

  const gradientMin = colorOverLifetime.color.gradientMin;
  gradientMin.addColorKey(0.0, new Color(1.0, 1.0, 1.0, 1.0));
  gradientMin.addColorKey(0.486, new Color(1.0, 0.5972017883637634, 0.0, 1.0));
  gradientMin.addColorKey(1.0, new Color(1.0, 0.1119324278369056, 0.0, 1.0));
