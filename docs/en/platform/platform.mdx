...
| Texture Type | See [Texture Compression](/docs/graphics/texture/compression/) for more details. |
...
Currently, Oasishub supports exporting to the following platforms:
