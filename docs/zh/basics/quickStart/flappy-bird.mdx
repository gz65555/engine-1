...
> 相信大家对 Flappy Bird 都不陌生，本文简单描述下如何用 Oasishub 复刻这个 2D 游戏。
>
...
Flappy Bird 依赖的资源是一堆图片，点击[这里](https://mdn.alipayobjects.com/huamei_yo47yq/afts/file/A*-LNCSqY9JAEAAAAAQcAAAAgAehuCAQ/fbAsset.zip)可以下载图片包到本地。解压之后看到以下图片：
...
<Image src="https://gw.alipayobjects.com/zos/OasisHub/6cabaeea-cc36-4fe1-8bb5-d7ed8a9a49b7/drag1.gif" />
