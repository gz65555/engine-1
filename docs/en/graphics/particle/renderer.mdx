...
The particle (Particle Renderer) [ParticleRenderer](/apis/core/#ParticleRenderer) of the Oasishub Engine is a commonly used rendering component with rich properties. By adjusting various property values, you can achieve colorful particle effects.
