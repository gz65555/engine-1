...
### 🎨 Shader
Shaders are programs that run on the GPU, responsible for calculating the final color of each pixel. Oasishub provides a powerful shader language that allows you to:
