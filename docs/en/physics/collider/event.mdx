...
Collision events are an important part of the physics system, allowing scripts to respond to physical interactions between objects. The Oasishub physics system provides two types of events: collision events and trigger events.
