...
为了方便开发者快速[开发 XR 项目](/docs/xr/quickStart/develop/)，Oasishub 提供了 [@oasishub/engine-toolkit-xr](/docs/xr/system/toolkit/) 高级组件 ，本文将详细讲述高级组件的属性与接口。
...
> 本质上都是基于脚本实现的高级功能，是对 **@oasishub/engine-xr** 核心操作的高级封装。
