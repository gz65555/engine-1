...
Collision shapes ([ColliderShape](/apis/core/#ColliderShape)) define the physical form of colliders. Oasishub provides several basic collision shapes that can be combined to create complex collision areas.
