...
| [sceneManager](/apis/core/#Engine-sceneManager) | Scene manager. Oasishub supports rendering multiple scenes simultaneously, and the scene manager allows convenient management of scene additions, deletions, modifications, and queries. More details can be found in [Scene](/en/docs/core/scene/). |
