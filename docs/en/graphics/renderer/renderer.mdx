...
In Oasishub, the following types of renderers are built-in:
...
`Renderer` is the base class for all renderers in Oasishub, and it includes the following properties:
