...
4. **Export glTF**
   ...
   Drag the exported glTF file into the editor or glTF Viewer. If the material type is **UnlitMaterial**, it means the [KHR_materials_unlit](https://github.com/KhronosGroup/glTF/tree/master/extensions/2.0/Khronos/KHR_materials_unlit) extension has been correctly applied, and Oasishub has parsed it into an Unlit material.
