...
This example demonstrates how to control animations with user input in the Oasishub editor. Through simple steps, you will learn how to switch animations based on user input, allowing the character to transition accordingly based on user interactions.
...
```typescript
import { Script, Animator, Keys } from '@oasishub/engine';
