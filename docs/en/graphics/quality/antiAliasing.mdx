...
Oasishub turns off 'FXAA' by default, which you can configure via 'antiAliasing' under the Camera or call [antiAliasing](/apis/core/#Camera-antiAliasing) interface.
...
In Oasishub, the default 'msaaSamples' under the camera is' 4x'. You can modify the 'msaaSamples' to customize the 'MSAA' quality. Or directly call [msaaSamples](/apis/core/#Camera-msaaSamples) interface Settings.
