...
The following is a set of guidelines for contributing to Oasishub. Please spend several minutes reading the article before you create an issue or pull request.<br />
...
<br />You can make use of the Github Issues for Oasishub to:<br />
...
1. Fork the Oasishub repository.
1. Run `npm run bootstrap` in your cloned folder to install all the dependencies for Oasishub.



### Making a Change

<br />After setting up the environment of Oasishub, you can make your change already. The only thing you should make sure is that you checked out the correct branch.<br />

### Test Your Change

<br />You can test your change by the following ways:<br />

- Clone the Oasishub playground repository and write a demo for your change.
- Write an uint test in the Oasishub repository and run `npm run test` to execute the uint test.

- Write an e2e test in the Oasishub repository and run `npm run e2e` to execute the e2e test.



### Submitting a Pull Request

<br />After you have made and tested your change, commit and push it to your fork. Then, open a Pull Request from your fork to the main Oasishub repository on the branch you used in the `Making a Change` section of this document.<br />
...
<br />Thank you to all the people who have already contributed to Oasishub!<br />
<br />// WIP: Contributors
