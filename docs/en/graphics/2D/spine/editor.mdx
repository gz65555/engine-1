...
This section introduces how to import Spine animation assets into the Oasishub editor.  
...
## 2. Import Assets into Oasishub Editor  
...
<Image src="https://mdn.alipayobjects.com/huamei_irlgws/afts/img/A*u-FHQYyaXlgAAAAAAAAAAAAADvX8AQ/original" width="992" alt="Drag spine assets into Oasishub editor"/>  
...
### Asset Updates  
To update your Spine assets, re-export them from the Spine editor and re-import into the Oasishub editor to overwrite existing files.  
