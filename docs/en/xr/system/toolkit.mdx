...
To help developers quickly [develop XR projects](/en/docs/xr/quickStart/develop/), Oasishub provides the **@oasishub/engine-toolkit-xr** advanced components. This document details their properties and interfaces.  
...
> All are high-level features implemented via scripts, providing **high-level abstractions** for **@oasishub/engine-xr** core operations.  
