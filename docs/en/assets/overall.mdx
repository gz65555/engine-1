...
In Oasishub, meshes, materials, textures, sprites, atlases, animation clips, animation controllers, etc., are all considered assets.

## Asset Workflow

In Oasishub, the asset workflow typically follows these steps:
