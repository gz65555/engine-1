...
Provides shadow-related functions. See the source code for details. ```glsl
...
This encapsulates the calculation of [ambient light](/en/docs/graphics/light/ambient) based on the BSDF lighting model. See the source code for details. Generally, you can call it directly:
